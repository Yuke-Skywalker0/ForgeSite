...
const features = [
  ...
  { icon: Search,       title: "SEO automatico",             text: "Meta tag, sitemap, dati strutturati Schema.org e Open Graph generati per ogni pagina senza configurazione manuale — mai più errori di indicizzazione." },
...
const numbers = [
  ...
  { value: "24 TLD",  label: "template pronti per ogni settore" },
];
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden px-6 pb-24 pt-28 text-center">
        <div className="pointer-events-none absolute left-1/2 top-[-200px] h-[500px] w-[800px] -translate-x-1/2 rounded-full bg-forge-accent/8 blur-3xl" aria-hidden="true" />
        <div className="pointer-events-none absolute right-[-100px] top-40 h-64 w-64 rounded-full bg-forge-info/8 blur-3xl" aria-hidden="true" />

        <div className="relative mx-auto max-w-3xl">
          <Reveal>
            <span className="mb-6 inline-flex items-center gap-2 rounded-full bg-forge-accent-dim px-4 py-1.5 text-xs font-medium text-forge-accent-soft">
          ...
          <Reveal delay={120}>
            <p className="mx-auto mb-10 max-w-xl text-lg text-forge-text-secondary">
              ...
              pubblicare siti veloci, sicuri e ottimizzati SEO — gratis, sull'infrastruttura che
              già conosci.
            </p>
          </Reveal>
          <Reveal delay={180}>
            <div className="mb-16 flex flex-wrap items-center justify-center gap-3">
              <Link
                to="/app/register"
                className="rounded-sm bg-forge-accent px-8 py-3.5 text-sm font-semibold text-forge-bg transition-colors hover:bg-forge-accent-soft"
              >
                Inizia gratis — nessuna carta richiesta
              </Link>
              <Link
                to="/confronto"
                className="rounded-sm border border-forge-border px-7 py-3.5 text-sm text-forge-text-primary transition-colors hover:border-forge-accent/40"
              >
        ...
        <div className="mx-auto max-w-6xl">
          <Reveal>
            <div className="mx-auto mb-14 max-w-xl text-center">
              <span className="mb-3 block font-mono text-xs uppercase tracking-wider text-forge-accent-soft">Cosa offriamo</span>
      ...
      <section className="bg-forge-surface px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <Reveal>
            <div className="mx-auto mb-14 max-w-xl text-center">
              <span className="mb-3 block font-mono text-xs uppercase tracking-wider text-forge-accent-soft">Come funziona</span>
      ...
      {/* CTA finale */}
      <section className="bg-forge-surface px-6 py-24 text-center">
        <Reveal>
          ...
          <Link
            to="/app/register"
            className="inline-block rounded-sm bg-forge-accent px-8 py-3.5 text-sm font-semibold text-forge-bg transition-colors hover:bg-forge-accent-soft"
          >
