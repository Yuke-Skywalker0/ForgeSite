    ...
    <>
      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-forge-bg px-6 py-16">
        ...
        <div className="w-full max-w-md rounded-lg border border-forge-border bg-forge-surface p-8 text-center">
          ...
          <span className="mb-2 block font-mono text-xs text-forge-text-muted">
            Passo {currentStep + 1} di {steps.length}
          </span>
          <h1 className="mb-3 font-display text-xl font-semibold text-forge-text-primary">{step.title}</h1>
          <p className="mb-7 text-sm leading-relaxed text-forge-text-secondary">{step.description}</p>
