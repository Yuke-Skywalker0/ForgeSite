...
const variantStyles: Record<ButtonVariant, string> = {
  primary: "bg-forge-accent text-forge-bg hover:bg-forge-accent-soft",
  secondary:
    "bg-forge-surface-raised text-forge-text-primary border border-forge-border hover:border-forge-accent/40",
