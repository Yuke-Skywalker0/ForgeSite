...
function findBlock(nodes: ReturnType<typeof useEditorStore.getState>["blockTree"], id: string) {
    ...
    return (
      <div className="flex w-72 flex-none flex-col border-l border-forge-border bg-forge-surface p-4">
        <p className="text-sm text-forge-text-muted">
          Seleziona un blocco per modificarne contenuto e stile.
        </p>
      </div>
    );
  }
        ...
        <section>
          ...
          <div className="flex flex-col gap-3">
            <Input
              ...
              placeholder="es. 24px"
              onChange={(e) =>
                updateBlockStyles(selectedBlock.id, activeBreakpoint, {
